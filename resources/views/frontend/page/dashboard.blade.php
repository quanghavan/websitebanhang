...
<div view="dashboard">
    ...
    @if(count($newpr) >0)
        <div style="text-align:center"><?php echo $newpr->appends(['newpr' => $newpr->currentPage()])->links()?></div>
    @endif
</div>
...
<div view="dashboard">
    ...
    <div class="line">
        <p>Tìm thấy {{count($khuyenmai)}} kết quả</p>
    </div>
    ...
    @if(count($khuyenmai) >0)
        <div style="text-align:center">  <?php echo $khuyenmai->appends(['khuyenmai' => $khuyenmai->currentPage()])->links()?>  </div>
    @endif
</div>
